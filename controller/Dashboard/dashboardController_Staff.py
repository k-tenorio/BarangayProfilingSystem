...
from view.Dashboard.dashboard_Staff import dashboard_Staff
from controller.RegisterResident.registerResidentController_Staff import RegisterResidentController_Staff
...
class DashboardStaff(QtWidgets.QDialog):
    logout_requested = pyqtSignal()

    def __init__(self):
        super().__init__()
        self.ui = dashboard_Staff()
    ...
    def open_view_population(self):
        from controller.ViewPopulation.viewPopulationController_Staff import ViewPopulationController_Staff

        self.view_population_window = ViewPopulationController_Staff(dashboard_reference=self)
    ...
    def open_register_resident(self):
        ...
        self.register_page = RegisterResidentController_Staff(parent=self)

        self.register_page.dashboard_requested.connect(self.show)
        self.register_page.logout_requested.connect(self.handle_logout)
