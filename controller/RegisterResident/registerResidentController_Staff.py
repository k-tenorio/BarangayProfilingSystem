# registerResidentController_Staff.py

from PyQt6 import QtWidgets, QtCore
from PyQt6.QtCore import pyqtSignal, QTimer
from view.RegisterResident.registerResident_Staff import register_Staff
...
class RegisterResidentController_Staff(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        if hasattr(self.ui, 'generateReports_Button_2'):
    ...
    def open_view_population(self):
        ...
        if dashboard and hasattr(dashboard, 'open_view_population'):
            ...
            self.close()
            self.view_pop = ViewPopulationController_Staff(dashboard_reference=dashboard)
            self.view_pop.show()
    ...
    def open_generate_reports(self):
        print("Generate Reports clicked from Register page")
